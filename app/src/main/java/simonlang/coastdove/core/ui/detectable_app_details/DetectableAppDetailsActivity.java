...
public class DetectableAppDetailsActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        try {
            detectionDataLoadedOrLoading = CoastDoveService.multiLoader.contains(this.appPackageName);
        ...
        activateSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    MultipleObjectLoader<AppDetectionData> multiLoader = CoastDoveService.multiLoader;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        AppDetectionData detectionData = CoastDoveService.multiLoader.get(this.appPackageName);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        try {
            ...
            boolean detectionDataLoading = CoastDoveService.multiLoader.getStatus(this.appPackageName)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        final AppDetectionData detectionData = CoastDoveService.multiLoader.get(this.appPackageName);
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
